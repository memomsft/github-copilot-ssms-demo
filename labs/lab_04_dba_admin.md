...
**Escenario:** *"Son las 2 AM. Hay alertas de lentitud en producción. Tienes 5 minutos para diagnosticar el problema."*
...
> 💡 **Para el ejercicio:** Estos tres prompts cubren el triángulo del diagnóstico de performance: queries lentas, índices innecesarios y wait stats. Antes requería conocimiento profundo de `sys.dm_exec_query_stats`, `sys.dm_db_index_usage_stats` y `sys.dm_os_wait_stats`.
...
> 💡 **Para el ejercicio:** Esta última pregunta es excelente para mostrar el multi-turn educativo - Copilot no solo da el comando, explica el impacto y puede guiar paso a paso por el proceso de prueba antes de hacer el cambio en producción.

---

## ⚠️ Limitación Importante a Señalar Aquí

> **Para el ejercicio:** Este es un momento ideal para mencionar la limitación de Agent Mode.
...
**Mensaje:** *"Esto es por diseño - Copilot no ejecuta comandos destructivos (DELETE, UPDATE, DROP) de forma autónoma. Microsoft tiene Agent Mode en el roadmap, que permitirá esto con aprobación explícita del usuario. Hoy, el DBA siempre tiene el control final."*
